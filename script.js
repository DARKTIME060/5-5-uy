...
let son = prompt("1 dan 1000 oraligida son kiriting ! (titleni tezligi)")

let soon = prompt("1 dan 1000 oraligida son kiriting ! (textni tezligi)")

let title = new Typing (".title", son);

let text = new Typing (".text", soon);
